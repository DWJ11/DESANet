...
def make_dataloader(cfg):
    ...
    train_set = ImageDataset(dataset.train, train_transforms,flag=1,datasets=cfg.DATASETS.NAMES)
    train_set_normal = ImageDataset(dataset.train, val_transforms,flag=0,datasets=cfg.DATASETS.NAMES)
    ...
    val_set = ImageDataset(dataset.query + dataset.gallery, val_transforms,flag=0,datasets=cfg.DATASETS.NAMES)
